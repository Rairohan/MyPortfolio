    ...
    return(
        <main>
            <section className="about-section" id='about'>
                ...
                <br />
                <p>
                    I’m an aspiring front-end developer who enjoys building clean, responsive, and user-friendly web interfaces.
                ...
                <div className="specs"> 
                    <button className="b1">Problem solver</button>
                    <button className="b2"> Team Player</button>
                    <button className="b3">Quick Learner</button>
                    <button className="b4">Adaptable</button>
                </div>
            </section>
        </main>
    )
